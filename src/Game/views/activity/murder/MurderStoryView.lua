--[[
 * author : liuzhipeng
 * descpt : 杀人案（19夏活）剧情收录view
--]]
local VIEW_SIZE = display.size
local MurderStoryView = class('MurderStoryView', function ()
	local node = CLayout:create(display.size)
	node.name = 'Game.views.summerActivity.MurderStoryView'
...
local RES_DICT = {
    COMMON_BG_GOODS                 = app.murderMgr:GetResPath('ui/common/common_bg_goods.png'),
    COMMON_ICO_LOCK                 = app.murderMgr:GetResPath('ui/common/common_ico_lock.png'),
    COMMON_ICO_RED_POINT            = app.murderMgr:GetResPath('ui/common/common_ico_red_point.png'),
    ...
    ANNI_PLOT_BOOKS_BG              = app.murderMgr:GetResPath('ui/anniversary/story/anni_plot_books_bg.png'),
    ANNI_PLOT_ICON_1                = app.murderMgr:GetResPath('ui/anniversary/story/anni_plot_icon_1.png'),
    ANNI_PLOT_ZHIXIAN_BG            = app.murderMgr:GetResPath('ui/anniversary/story/anni_plot_zhixian_bg.png'),
    ANNI_PLOT_ZHUXIAN_BG            = app.murderMgr:GetResPath('ui/anniversary/story/anni_plot_zhuxian_bg.png'),
    TASK_BTN_PLAYBACK               = app.murderMgr:GetResPath('ui/home/story/task_btn_playback.png'),
    ANNI_PLOT_REVIEW_UNLOCK         = app.murderMgr:GetResPath('ui/anniversary/story/anni_plot_review_unlock.png'),
    ANNI_PLOT_REVIEW_DEFAULT        = app.murderMgr:GetResPath('ui/anniversary/story/anni_plot_review_default.png'),
}

function MurderStoryView:ctor( ... )
    self.args = unpack({...}) or {}
    self:initialUI()
end

function MurderStoryView:initialUI()
    xTry(function ( )
...
--@return
--==============================--
function MurderStoryView:updateStoryList(storyDatas)
...
--@return
--==============================--
function MurderStoryView:updateGroupCell(viewData, data, iconPath)
...
function MurderStoryView:updateGroupIcon(viewData, data, iconPath)
    local groupId       = data.groupId
    local groupIcon     = viewData.groupIcon
    groupIcon:setTexture(iconPath or app.murderMgr:GetResPath(string.format( "ui/home/activity/murder/plotIcon/murder_plot_icon_%s", groupId)))
end
...
--@return
--==============================--
function MurderStoryView:updateGroupBgByIndex(index, isSelect)
...
--@return
--==============================--
function MurderStoryView:updateGroupCellBg(viewData, isSelect)
...
--@return
--==============================--
function MurderStoryView:updateStoryCell(viewData, data)
...
--@return
--==============================--
function MurderStoryView:updateStoryCellBg(viewData, isUnlock)
    local cellBg = viewData.cellBg
    cellBg:setTexture(isUnlock and RES_DICT.ANNI_PLOT_REVIEW_DEFAULT or RES_DICT.ANNI_PLOT_REVIEW_UNLOCK)
    
end

function MurderStoryView:CreateGroupCell(size)
    return CreateGroupCell_(size)
end

function MurderStoryView:CreateStoryCell(size)
...
CreateView = function ()
    ...
    {
        text = app.murderMgr:GetPoText(__('剧情目录')),
        ap = display.CENTER,
        fontSize = 26,
        color = '#5b3c25',
    ...
    --     text = app.murderMgr:GetPoText(__('收集奖励')),
    --     ap = display.CENTER,
    -- }))
...
function MurderStoryView:getViewData()
    return self.viewData_
end

return MurderStoryView
