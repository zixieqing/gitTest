local ActivityAllRoundRewardsPreviewView = class('ActivityAllRoundRewardsPreviewView', function ()
    local node = CLayout:create(display.size)
    node.name = 'Game.views.allRound.ActivityAllRoundRewardsPreviewView'
...
function ActivityAllRoundRewardsPreviewView:ctor( param )
    local param = param or {}
    local routeId =  param.routeId or 1
    self.rewards = checktable(param.rewards)
    self.routeId = routeId
    self:InitUI()
    self:CreateGoodNode()
end
function ActivityAllRoundRewardsPreviewView:InitUI()
...
function ActivityAllRoundRewardsPreviewView:CreateGoodNode()
...
return ActivityAllRoundRewardsPreviewView