...
特殊活动 累充活动页签view
--]]
local SpActivityAccumulativePayPageView = class('SpActivityAccumulativePayPageView', function ()
    local node = CLayout:create()
    node.name = 'home.SpActivityAccumulativePayPageView'
...
function SpActivityAccumulativePayPageView:ctor( ... )
	local args = unpack({...})
    self.size = args.size
    self:InitUI()
end
 
function SpActivityAccumulativePayPageView:InitUI()
...
return SpActivityAccumulativePayPageView
