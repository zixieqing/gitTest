...
--]]
local SpActivityCommonPageView = class('SpActivityCommonPageView', function ()
    local node = CLayout:create()
    node.name = 'home.SpActivityCommonPageView'
...
function SpActivityCommonPageView:ctor( ... )
	local args = unpack({...})
    self.size = args.size
    self:InitUI()
end
 
function SpActivityCommonPageView:InitUI()
...
return SpActivityCommonPageView
