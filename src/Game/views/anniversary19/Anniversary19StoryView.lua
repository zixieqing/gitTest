...
---@class Anniversary19StoryView
local Anniversary19StoryView = class('Anniversary19StoryView', function ()
	local node = CLayout:create(display.size)
	node.name = 'Game.views.anniversary19.Anniversary19StoryView'
...
local RES_DICT = {
    ...
    COMMON_ICO_LOCK                      = app.anniversary2019Mgr:GetResPath('ui/common/common_ico_lock.png'),
    COMMON_ICO_RED_POINT                 = app.anniversary2019Mgr:GetResPath('ui/common/common_ico_red_point.png'),
    SUMMER_ACTIVITY_EGG_EXTRA_BAR_GREY   = app.anniversary2019Mgr:GetResPath('ui/home/activity/summerActivity/carnie/summer_activity_egg_extra_bar_grey.png'),
    SUMMER_ACTIVITY_EGG_EXTRA_BAR_ACTIVE = app.anniversary2019Mgr:GetResPath('ui/home/activity/summerActivity/carnie/summer_activity_egg_extra_bar_active.png'),
    ANNI_PLOT_BOOKS_BG                   = app.anniversary2019Mgr:GetResPath('ui/anniversary/story/anni_plot_books_bg.png'),
    ANNI_PLOT_ICON_1                     = app.anniversary2019Mgr:GetResPath('ui/anniversary/story/anni_plot_icon_1.png'),
    ANNI_PLOT_ZHIXIAN_BG                 = app.anniversary2019Mgr:GetResPath('ui/anniversary/story/anni_plot_zhixian_bg.png'),
    ANNI_PLOT_ZHUXIAN_BG                 = app.anniversary2019Mgr:GetResPath('ui/anniversary/story/anni_plot_zhuxian_bg.png'),
    TASK_BTN_PLAYBACK                    = app.anniversary2019Mgr:GetResPath('ui/home/story/task_btn_playback.png'),
    ANNI_PLOT_REVIEW_UNLOCK              = app.anniversary2019Mgr:GetResPath('ui/anniversary/story/anni_plot_review_unlock.png'),
    ANNI_PLOT_REVIEW_DEFAULT             = app.anniversary2019Mgr:GetResPath('ui/anniversary/story/anni_plot_review_default.png'),
}

function Anniversary19StoryView:ctor( ... )
    self.args = unpack({...}) or {}
    self:InitialUI()
end

function Anniversary19StoryView:InitialUI()
    xTry(function ( )
...
--@return
--==============================--
function Anniversary19StoryView:UpdateStoryList(storyDatas)
...
--@return
--==============================--
function Anniversary19StoryView:UpdateGroupCell(viewData, data, iconPath)
...
--@return
--==============================--
function Anniversary19StoryView:UpdateGroupBgByIndex(index, isSelect)
...
--@return
--==============================--
function Anniversary19StoryView:UpdateGroupCellBg(viewData, isSelect)
...
--@return
--==============================--
function Anniversary19StoryView:UpdateStoryCell(viewData, data)
...
--@return
--==============================--
function Anniversary19StoryView:UpdateStoryCellBg(viewData, isUnlock)
    local cellBg = viewData.cellBg
    cellBg:setTexture(isUnlock and RES_DICT.ANNI_PLOT_REVIEW_DEFAULT or RES_DICT.ANNI_PLOT_REVIEW_UNLOCK)
    
end

function Anniversary19StoryView:CreateGroupCell(size)
    return CreateGroupCell_(size)
end

function Anniversary19StoryView:CreateStoryCell(size)
...
CreateView = function ()
    ...
    {
        text = app.anniversary2019Mgr:GetPoText(__('剧情目录')),
        ap = display.CENTER,
        fontSize = 26,
        color = '#5b3c25',
    ...
    --     text = app.anniversary2019Mgr:GetPoText(__('收集奖励')),
    --     ap = display.CENTER,
    -- }))
...
function Anniversary19StoryView:GetViewData()
    return self.viewData_
end

return Anniversary19StoryView
