...
抽卡动画view
--]]
local CapsuleAnimateView = class('CapsuleAnimateView', function ()
    local node = CLayout:create(display.size)
    node.name = 'home.CapsuleAnimateView'
...
function CapsuleAnimateView:ctor( ... )
    self:InitUI()
end
--[[
init ui
--]]
function CapsuleAnimateView:InitUI()
...
--]]
function CapsuleAnimateView:StartCapsuleAnimation( isRare )
...
将背景spine恢复为idle状态
--]]
function CapsuleAnimateView:RecoverCapsuleIdleState()
