...
local SpringActivity20PointRewardsView = class('SpringActivity20PointRewardsView', CommonDialog)

local RES_DICT = {
    COMMON_BTN_ORANGE               = app.springActivity20Mgr:GetResPath('ui/common/common_btn_orange.png'),
    CASTLE_BG_COMMON_BOARD          = app.springActivity20Mgr:GetResPath('ui/common/common_bg_4.png'),
    CASTLE_POINT_BG_BOARD           = app.springActivity20Mgr:GetResPath('ui/home/activity/murder/murder_point_bg_board.png'),
    CASTLE_POINT_BTN_PLAY_LOCK      = app.springActivity20Mgr:GetResPath('ui/home/activity/murder/murder_point_btn_play_lock.png'),
    CASTLE_POINT_LINE_TITLE         = app.springActivity20Mgr:GetResPath('ui/castle/plotReward/castle_point_line_title.png'),
    CASTLE_POINT_LIST_BG_SP         = app.springActivity20Mgr:GetResPath('ui/springActivity20/pointRewards/murder_point_list_bg_sp.png'),
    CASTLE_POINT_LIST_LABEL         = app.springActivity20Mgr:GetResPath('ui/springActivity20/pointRewards/murder_point_list_label.png'),
    CASTLE_POINT_LIST_LINE          = app.springActivity20Mgr:GetResPath('ui/home/activity/murder/murder_point_list_line.png'),
    CASTLE_POINT_LIST_BG_DEFAULT    = app.springActivity20Mgr:GetResPath('ui/springActivity20/pointRewards/murder_point_list_bg_default.png'),
    CASTLE_POINT_BG_CARD_200096     = app.springActivity20Mgr:GetResPath('ui/springActivity20/pointRewards/murder_point_bg_card.png'),
    CASTLE_POINT_BTN_PLAY_NEW       = app.springActivity20Mgr:GetResPath('ui/home/activity/murder/murder_point_btn_play_new.png'),
    CASTLE_POINT_BTN_PLAY_DEFAULT   = app.springActivity20Mgr:GetResPath('ui/home/activity/murder/murder_point_btn_play_default.png'),
    CASTLE_POINT_BG_PATH_LOCK       = app.springActivity20Mgr:GetResPath('ui/home/activity/murder/murder_point_bg_path_lock.png'),
    CASTLE_POINT_BG_PATH_DEFAULT    = app.springActivity20Mgr:GetResPath('ui/home/activity/murder/murder_point_bg_path_default.png'),
    CASTLE_POINT_LABEL_NUM_1        = app.springActivity20Mgr:GetResPath('ui/home/activity/murder/murder_point_label_num_1.png'),
    CASTLE_POINT_LABEL_NUM_2        = app.springActivity20Mgr:GetResPath('ui/home/activity/murder/murder_point_label_num_2.png'),
    MURDER_POINT_BG_GAINED          = app.springActivity20Mgr:GetResPath('ui/springActivity20/pointRewards/murder_point_label_gained.png'),
    MASK_BG                         = app.springActivity20Mgr:GetResPath('ui/home/activity/murder/murder_point_cover_lock.png'),
    
    ANNI_REWARDS_LABEL_CARD_PREVIEW = app.springActivity20Mgr:GetResPath('ui/anniversary/rewardPreview/anni_rewards_label_card_preview.png'),
...
function SpringActivity20PointRewardsView:InitialUI( )
...
function SpringActivity20PointRewardsView:InitView()
...
--==============================--
function SpringActivity20PointRewardsView:InitPlotListView(datas)
    ...
    --     local icon = display.newImageView(app.springActivity20Mgr:GetResPath(string.format('ui/home/activity/murder/murder_chess_img_clock_%d.png', checkint(datas[lockIndex].unlockClockLevel))), middleWidth, maskSize.height - 80)
    --     icon:setScale(0.5)
    --     maskLayer:addChild(icon, 5)
    --     local unlockLabel = display.newLabel(20, maskSize.height - 140, {fontSize = 20, text = string.fmt(app.springActivity20Mgr:GetPoText(__('时针指向_num_点解锁')), {['_num_'] = checkint(datas[lockIndex].unlockClockLevel) * 2}), color = '#ffffff', w = 200, ap = display.LEFT_TOP, hAlign = cc.TEXT_ALIGNMENT_CENTER})
...
--==============================--
function SpringActivity20PointRewardsView:UpdatePlotListNodeByIndex(index, data)
    local viewData = self:GetViewData()
...
--==============================--
function SpringActivity20PointRewardsView:UpdatePlotCell(plotCell, targetGoodsId, targetNum, plotUnlockState)
...
--==============================--
function SpringActivity20PointRewardsView:UpdateTableView(datas)
...
--==============================--
function SpringActivity20PointRewardsView:UpdateCell(viewData, data)
...
--==============================--
function SpringActivity20PointRewardsView:UpdateRareReward(data)
    local viewData = self:GetViewData()
    self:UpdateRewardCell_(viewData, data)
    local cardPreviewBtn = viewData.cardPreviewBtn
    local paramsConf = CommonUtils.GetConfigAllMess('param' , 'springActivity2020')
    local confId = checkint(paramsConf.rewardDraw)
...
--==============================--
function SpringActivity20PointRewardsView:UpdateNumLabel(curPoint)
...
--@params data          table     剧情奖励数据
--==============================--
function SpringActivity20PointRewardsView:UpdateRewardCell_(viewData, data)
...
--==============================--
function SpringActivity20PointRewardsView:UpdateRewardLayer_(viewData, data)
...
--@params plotUnlockState    int   0 不满足条件 1 满足条件 2  满足条件并且是最新解锁剧情
--==============================--
function SpringActivity20PointRewardsView:GetPlotPathByState(plotUnlockState)
    local img = nil
...
CreateView = function ()
    ...
    local tipsLabel = display.newLabel(137, 34, {text = app.springActivity20Mgr:GetPoText(__('收集启示数来解锁更多剧情秘密吧!')), fontSize = 20, color = '#ffffff', w = 245})
    ...
    {
        text = app.springActivity20Mgr:GetPoText(__('达到')),
    ...
    local pointIcon = display.newNSprite(CommonUtils.GetGoodsIconPathById(app.springActivity20Mgr:GetPointGoodsId()), 123, 56,
    {
        ap = display.LEFT_CENTER
    })
    ...
    {
        text = app.springActivity20Mgr:GetPoText(__('已获得启示数')),
        ap = display.RIGHT_CENTER,
        fontSize = 20,
        color = '#ffcfa0',
    })
    ...
    local fragmentIcon = display.newNSprite(CommonUtils.GetGoodsIconPathById(app.springActivity20Mgr:GetPointGoodsId()), 786, 587,
    {
        ap = display.CENTER,
    })
    ...
    -- card preview btn
    local cardPreviewBtn = require("common.CardPreviewEntranceNode").new({confId = 200180})
...
CreateCell_ = function (size)
    ...
    cell:addChild(display.newLabel(16, 91, {text = app.springActivity20Mgr:GetPoText(__('达到')), ap = display.LEFT_CENTER, fontSize = 20, color = '#ffffff'}))
    ...
    local pointIcon = display.newNSprite(CommonUtils.GetGoodsIconPathById(app.springActivity20Mgr:GetPointGoodsId()), 110, 58,
    {
        ap = display.LEFT_CENTER
    })
    pointIcon:setScale(0.2)
...
function SpringActivity20PointRewardsView:CreateCell(size)
    return CreateCell_(size)
end

function SpringActivity20PointRewardsView:GetViewData()
    return self.viewData
end

function SpringActivity20PointRewardsView:CloseHandler()
    app:UnRegsitMediator(self.args.mediatorName)
end

return  SpringActivity20PointRewardsView