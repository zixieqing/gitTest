...
[lower, upper]
--]]
function RandomManager:GetRandomIntByRange(lower, upper)
	return math.round(self:GetRandomValue() * (upper - lower)) + lower
end
--[[
获取一次随机浮点数数
(0, upper]
--]]
function RandomManager:GetRandomFloat(upper)
	return self:GetRandomValue() * upper
end
---------------------------------------------------
-- control end --
---------------------------------------------------
