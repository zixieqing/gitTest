local CapsuleURProbabilityUPView = class('CapsuleURProbabilityUPView', function ()
    local node = CLayout:create()
    node.name = 'home.CapsuleURProbabilityUPView'
...
function CapsuleURProbabilityUPView:ctor( ... )
	local args = unpack({...})
...
function CapsuleURProbabilityUPView:RefreshUI(  )
end

return CapsuleURProbabilityUPView
