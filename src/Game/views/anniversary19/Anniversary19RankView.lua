...
--]]
local Anniversary19RankView = class('Anniversary19RankView', function ()
    local node = CLayout:create(display.size)
    node.name = 'Game.views.anniversary19.Anniversary19RankView'
...
local RES_DICT = {
    MAIN_BG                           = app.anniversary2019Mgr:GetResPath('arts/stage/bg/main_bg_06.jpg'),
    COMMON_TITLE_NEW                  = app.anniversary2019Mgr:GetResPath('ui/common/common_title_new.png'),
    COMMON_BTN_BACK                   = app.anniversary2019Mgr:GetResPath("ui/common/common_btn_back.png"),
    RANK_BG_LIEBIAO                   = app.anniversary2019Mgr:GetResPath('ui/home/rank/rank_bg_liebiao.png'),
    RANK_IMG_UP                       = app.anniversary2019Mgr:GetResPath('ui/home/rank/rank_img_up.png'),
    RANK_IMG_DOWN                     = app.anniversary2019Mgr:GetResPath('ui/home/rank/rank_img_down.png'),
    COMMON_RANK_BG                    = app.anniversary2019Mgr:GetResPath('ui/common/common_rank_bg.png'),
    RESTAURANT_INFO_BG_RANK_TITLE     = app.anniversary2019Mgr:GetResPath('ui/home/rank/restaurant_info_bg_rank_title.png'),
    RESTAURANT_INFO_BG_RANK_MINE      = app.anniversary2019Mgr:GetResPath('ui/home/rank/restaurant_info_bg_rank_mine.png'),
    RESTAURANT_INFO_BG_RANK_AWARENESS = app.anniversary2019Mgr:GetResPath('ui/home/lobby/information/restaurant_info_bg_rank_awareness.png'),
    RESTAURANT_INFO_BG_RANK_NUM1      = app.anniversary2019Mgr:GetResPath('ui/home/rank/restaurant_info_bg_rank_num1.png'),
    COMMON_BTN_ORANGE                 = app.anniversary2019Mgr:GetResPath('ui/common/common_btn_orange.png'),
}

function Anniversary19RankView:ctor(...)
    local args = unpack({...})
    self.viewData = nil
    local function CreateView()
        ...
        display.commonLabelParams(tabNameLabel, {ttf = true, font = TTF_GAME_FONT, text = app.anniversary2019Mgr:GetPoText(__('排行榜')), fontSize = 30, color = '473227',offset = cc.p(0,-8)})
		...
		local tipsLabel = display.newLabel(28, 565, fontWithColor(6, {text = app.anniversary2019Mgr:GetPoText(__('排行榜每小时更新一次排名')), ap = cc.p(0, 0.5)}))
		...
		local scoreIcon = display.newImageView('', 985, 37)
        ...
        -- 未入榜
		local playerRankLabel = display.newLabel(88, 35, {text = app.anniversary2019Mgr:GetPoText(__('未入榜')), fontSize = 22, color = '#ba5c5c'})
		...
		display.commonLabelParams(rewardBtn, {fontSize = 20, color = 'ffffff', font = TTF_GAME_FONT, ttf = true, outline = '734441', text = app.anniversary2019Mgr:GetPoText(__('查看奖励'))})
...
function Anniversary19RankView:onCleanup()
end

return Anniversary19RankView