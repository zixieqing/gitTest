...
local TTGameShopPackageView = class('TripleTriadGameShopPackageView', function()
    return display.newLayer(0, 0, {name = 'Game.views.stores.TripleTriadGameShopPackageView'})
end)
...
function TTGameShopPackageView:ctor(size)
...
function TTGameShopPackageView:getViewData()
...
function TTGameShopPackageView.createGoodsCell(size)
    return CreateGoodsCell(size)
end


return TTGameShopPackageView
