...
local podTable = {
	po = {
		...
		[__("全部支线关卡难度20通关可解锁快速游玩，快速游玩仅能获得难度20时关卡的通关奖励。")] = __("全部支线关卡难度20通关可解锁快速游玩，快速飞巡仅能获得难度20时关卡的通关奖励。"),
		[__("替换")] = __("替换"),
		[__("雇佣")] = __("雇佣"),
		[__("保存设置")] = __("保存设置"),
		[__("当前排名")] = __("当前排名"),
		...
		[__("关卡暂未解锁")] = __("关卡暂未解锁"),
		[__("排行榜")] = __("排行榜"),
		[__("庆典积分排行奖励")] = __("溯世卷排行奖励"),
		[__("诞生年代：")] = __("诞生年代："),
		[__("%d小时后解锁")] = __("%d小时后解锁"),
		[__("排名奖励")] = __("排名奖励"),
		[__("正在游戏中")] = __("正在游戏中"),
		[__("每日摊位排行奖励")] = __("每日集市排行奖励"),
		...
		[__("食谱商店")] = __("食谱商店"),
		[__("描述")] = __("描述"),
		[__("翻开一张牌，决定游玩的区域")] = __("翻开一张牌，决定飞巡的区域"),
		[__("剩余数量：%d")] = __("剩余数量：%d"),
		[__("排名规则")] = __("排名规则"),
		[__("今日推荐料理")] = __("今日推荐料理"),
		...
		[__("销售数量")] = __("销售数量"),
		[__("当前阶段：%s")] = __("当前阶段：%s"),
		[__("未能及时做好今日营业准备，本摊位暂停售卖。")] = __("未能及时做好今日营业准备，本集市暂停售卖。"),
		[__("庆典积分排名")] = __("溯世卷排名"),
		[__("请添加飨灵")] = __("请添加飨灵"),
		[__("源地：")] = __("源地："),
		[__("领取奖励")] = __("领取奖励"),
	...
	spine = {
		...
		ANNI_MAIN_UP        = 'effects/anniversary/anni_main_up',
		FFALL               = 'effects/anniversary/Ffall',
	},
	pos = {
	},
	shopRole = 'role_250',
	manBgmId = AUDIOS.SSG.FOOD_SSG_SUSHISHU.id,
	dialogIndex = "4",
	entryViewData = {
		cardId = "200294",
		isNpc = false ,
		mainBgImage = "arts/stage/bg/main_bg_271_1.jpg",
		npcPos = cc.p(display.width - 300, display.cy - 300)
	},
	capsuleDrawNode = "200294" ,
	branchDrawNode = "200274",
	dayAndNight = false ,
