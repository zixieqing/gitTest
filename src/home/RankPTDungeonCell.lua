--[[
    排行榜pt本排行Cell
--]]
local RankPTDungeonCell = class('RankPTDungeonCell', function ()
    local RankPTDungeonCell = CGridViewCell:new()
    RankPTDungeonCell.name = 'home.RankPTDungeonCell'
    RankPTDungeonCell:enableNodeEvents()
    return RankPTDungeonCell
end)

function RankPTDungeonCell:ctor( ... )
    local arg = { ... }
    local size = arg[1]
