...
function BossCutinScene:initView()
	...
	local stencilLayer = SpineCache(SpineCacheName.BATTLE):createWithName('boss_cutin_mask')
	...
	local spineBg = SpineCache(SpineCacheName.BATTLE):createWithName('boss_cutin_1')
	...
	local spineFg = SpineCache(SpineCacheName.BATTLE):createWithName('boss_cutin_2')
	...
	self.ciAnimationConf = {
		...
		drawNodeMoveTime = SpineCache(SpineCacheName.BATTLE):getAnimationsDataByName('boss_cutin_1').animation.duration,
		drawNodeMoveY = 200,
...
function BossCutinScene:startMainDrawNodeAnimation()
	local disappearDelayTime = SpineCache(SpineCacheName.BATTLE):getAnimationsDataByName('boss_cutin_1').animation.duration -
		SpineCache(SpineCacheName.BATTLE):getAnimationsDataByName('boss_cutin_mask').animation.duration
	-- 背景渐变
